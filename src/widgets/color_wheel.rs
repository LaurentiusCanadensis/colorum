...
use iced::{
    alignment, mouse, Alignment, Background, Border, Color, Element, Length, Padding, Point,
    Rectangle,
    ...
    F: Fn(Channel, u8) -> Msg + Clone + 'static,
{
    ...
    fn draw(
        ...
        // Cached rings
        let rings = self.cache.draw(renderer, bounds.size(), |frame: &mut Frame| {
